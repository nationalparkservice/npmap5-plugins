...
export default class BindPopup {
    ...
    highlightFeature(feature: QueryFeature, map: MaplibreMap) {
        ...
        if (featureType === 'symbol') {
            ...
            layerLayout = (feature.layer.layout as any);
        }
    ...
    private _templater(exp: DataDrivenPropertyValueSpecification<string>, feature: QueryFeature, map?: MaplibreMap): HTMLSpanElement {
    ...
    private _formatter(feature: QueryFeature, popupTemplate: popupTemplate, map?: MaplibreMap): HTMLElement {
        ...
        const templateToElement = (elementType: string, exp: DataDrivenPropertyValueSpecification<string>) => {
