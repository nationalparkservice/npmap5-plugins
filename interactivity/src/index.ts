...
import Accessibility, { AccessibilityOptions } from './accessibility';
...
export default class Interactive {
    ...
    addAccessibility(layerName: string, options: AccessibilityOptions) {
        return this._accessibility.addLayer(layerName, options);
    }
    removeAccessibility(layerName: string) {
