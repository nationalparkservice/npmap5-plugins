...
export default class maplibreTextTemplate {
    ...
    evaluateText(expression: DataDrivenPropertyValueSpecification<string>,
    ...
    evaluateHtml(expression: DataDrivenPropertyValueSpecification<string>,
        properties: { [key: string]: string },
    ...
    private async _evaluate(
        expression: DataDrivenPropertyValueSpecification<string>,
        properties: { [key: string]: string },
        featureState?: QueryFeature['state'],
        ...
        const layer = this._map.getLayer(layerId) as FillStyleLayer;
