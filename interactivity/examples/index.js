...
import Interactivity from '../dist/interactivity.esm.js'
...
map.on('load', () => {
    ...
    addSvgToMap('lighthouse', lighthouseSVG, map, [22, 22]).finally(() =>
        addSvgToMap('airplane', airplaneSVG, map, [22, 22]).finally(() => {
            ...
            popupListener.addAccessibility(layerIdPrefix + symbolName, { 'labelField': 'man_made' });
            ...
            popupListener.addAccessibility(layerIdPrefix + fillName, { 'labelField': 'natural', 'drawFeature': false });
